...
## Project Overview
Hookhunt is a React-based party game application with two game modes: Classic (team-based) and NameBlame (player-specific blaming). Built with React 19, TypeScript, Vite, Tailwind CSS, and Framer Motion with comprehensive multilingual support and PWA capabilities.

## Architecture & Data Flow

### Core State Management
- **Zustand Store** (`store/HookhuntStore.ts`): Game-specific state for NameBlame mode progression
