...
export default {
  ...
  safelist: [
    // HookHunt palette utilities that may be built dynamically
    'from-cyan-500', 'via-teal-500', 'to-blue-600',
    'bg-slate-800', 'text-cyan-600', 'dark:text-cyan-400',
    'from-cyan-500/10', 'via-teal-500/10', 'to-blue-600/10',
    'text-slate-400', 'text-emerald-400',
    // Generic mapping used by SplitText dynamic classes in GameShell
